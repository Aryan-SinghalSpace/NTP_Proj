...
export const EyeOffIcon = (p: P) => (
  <svg {...S(p)}>
    <path d="M9.9 5.2A9.8 9.8 0 0 1 12 5c7 0 10.5 7 10.5 7a17 17 0 0 1-3.3 4.1M6.6 6.6A17 17 0 0 0 1.5 12S5 19 12 19a9.6 9.6 0 0 0 5.4-1.6" />
...
/** Brand SSO marks — full colour, so drawn with fills (not the stroke helper). */
...
export const MicrosoftIcon = (p: P) => (
